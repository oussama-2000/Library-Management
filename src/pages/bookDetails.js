...
export default function BookDetails() {
  ...
  const AddToList = () => {
    ...
    alert(`successfully added this book to the list :${listName}`);
    setListName("");
  };
              ...
              <div className="options">
                <div className="bookImage">
                  <div className="title-mobile">
                    <div>
                      <div className="bookTitle-mobile">{book.title}</div>
                      <div className="bookAuthor-mobile">
                        <span>by</span>
                        <span>
                          <a
                      ...
                      <div className="bookStars-mobile">
                        <span className="star">
                ...
                {book.reviews.map((r, index) => (
                  <div className="bookReview">
                    <span className="star">
                      {[...Array(Number.isInteger(r.stars) ? r.stars : 0)].map(
                        (_, i) => (
                          <img
                            key={i}
                            src={starImage}
                    ...
                    <span>
                      ...
                      <button
                        ...
                        title="drop comment"
                        onClick={() => RemoveComment(book.id, index)}
                      >
                        X
                      </button>
                    </span>
